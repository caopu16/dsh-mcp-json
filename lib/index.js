...
*/
const MCP_JSON_SETTINGS_NAMESPACE = settingsNamespace("mcp-json");
/**
...
function apply(ctx, config) {
	...
	*/
	...
	const rewatch = () => {
		...
		watcher = watch(active.paths, { ignoreInitial: true });
		watcher.on("all", () => {
...
//#endregion
export { Config, DEFAULT_USER_PATH, MCP_JSON_SETTINGS_NAMESPACE, McpJsonEntryError, apply, discover, ensureDocument, expandHome, inject, isDisabled, layerSources, name, normalizeDocument, parseJsonc, readLayer, resolveConfig, stripJsonExtras, toClientConfig };